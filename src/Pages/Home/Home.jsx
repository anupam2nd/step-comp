...
export default function Home() {
  return (
    <div>
      <nav className="bg-gradient-to-r from-slate-100 to-sky-500 w-full">
          ...
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4">
                ...
                <Link to={'/faqs'} class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Faqs</Link>
